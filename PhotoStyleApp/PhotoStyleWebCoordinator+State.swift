...
extension PhotoStyleWebCoordinator {
    ...
    func baseStatePayload() -> [String: Any] {
        [
            ...
            "printRecipes": PhotoPrintRecipe.allCases.map { recipe -> [String: Any] in
                ["id": recipe.rawValue, "title": recipe.title,
                 "paperProfile": recipe.paperProfile.rawValue, "paperScatter": recipe.scatter,
                 "paperWhite": recipe.white, "paperDensityOffset": recipe.densityOffset]
            },
