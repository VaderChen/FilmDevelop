...
enum PhotoStyleMCPTools {
    static let numericRanges: [String: ClosedRange<Double>] = {
        ...
        for key in ["skinWarmth", "exposure", "vibrance", "saturation", "whiteBalanceWarmth", "whiteBalanceTint", "contrast", "vignetteBalance", "cropHorizontalPosition", "cropVerticalPosition"] { ranges[key] = -100...100 }
