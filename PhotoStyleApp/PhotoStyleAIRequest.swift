...
enum PhotoStyleAIRequest {
    ...
    - print_exposure_highlights, print_exposure_midtones and print_exposure_shadows independently control exposure in EV (-16...16). Smooth overlapping luminance weights blend these before exposure. Set all three to print_exposure for global exposure; missing zone values inherit print_exposure.
    ...
    static let grammar: String = {
        ...
        return [
            ...
            "film ::= " + object([
                ...
                ("color_model", "film-color"), ("print_exposure", "print-ev"), ("print_exposure_highlights", "print-ev"), ("print_exposure_midtones", "print-ev"), ("print_exposure_shadows", "print-ev"), ("print_contrast", "percent"),
            ...
            #"scanner-profile ::= ("\"off\"" | "\"neutral\"" | "\"warmCool\"" | "\"softPortrait\"" | "\"vivid\"" | "\"coolClean\"" | "\"fadedVintage\"" | "\"frontierSP500\"" | "\"noritsuHS1800\"" | "\"flextightX5\"" | "\"coolscan9000\"" | "\"epsonV850\"") ws"#,
