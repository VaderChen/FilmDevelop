...
## 이번 업데이트 — 1.26.0926 build 1714

1.26.0926 build 1603의 모든 변경 사항을 포함합니다.
...
- 핵심 필름 23종의 재료 기본값, 사진 레시피 4종, 복구 브러시 실행 시 모델 준비를 추가했습니다. 재료와 현상 효과는 예술적 근사입니다.
...
사진 스캔은 필름 → 광학 인화 → 종이 효과 → 사진 스캔 순서이며 노출이나 네거티브 반전을 중복하지 않습니다. 필름 직접 스캔과 리버설에는 종이 효과를 적용하지 않습니다. 기존 레시피는 필름이 기본값입니다. 실측 재현이 아닌 예술적 근사입니다.
